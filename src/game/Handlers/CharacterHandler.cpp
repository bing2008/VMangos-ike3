...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADSPELLCOOLDOWNS,  "SELECT SpellId,ItemId,SpellExpireTime,CategoryExpireTime FROM character_spell_cooldown WHERE guid = '%u'", m_guid.GetCounter());
